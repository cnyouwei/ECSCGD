...
# mu = [0.31392958060294585, 0.2670507568110503, -0.8139565670910487, -0.15440490725536993, 0.31201243955133595, 0.4413006955192582, 0.9205173787352825, -0.7011192703499398, -0.24702587179748248, -0.5434569347298084]
...
time = Dates.format(Dates.now(), "yyyymmdd_HH_MM")
mkpath("./Data/")

f_name_base = "./Data/" * case_name * "d" * string(n) * "_" * time
